...
export function buildHuffTree(symbolSizes) {
...
export function huffTreeToBitArrays(tree) {
    const res = [];
...
export function huffBitsNeeded(sizes) {
...
export function theoreticalBitsNeeded(sizes) {
    const sum = sizes.reduce((a, b) => a + b);
    let averageBits = 0;
