...
exports.encodeSizes = encodeSizes;
exports.decodeSizes = decodeSizes;
const minSize = 10;
...
function decodeSizes(buf) {
    const res = Array.from({ length: buf.length });
