...
const MuteWordsModal: React.FC<MuteWordsModalProps> = ({
  ...
  return createPortal(
    <>
      ...
      {/* Modal */}
      <div className="fixed z-[70] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-md rounded-xl shadow-2xl border bg-black border-yellow-500/30">
        {/* Header */}
