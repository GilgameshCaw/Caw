...
const TipAttachmentControl: React.FC<Props> = ({
  ...
  return (
    <>
      ...
      >
        {/* Tip icon: open-arc coin enclosing a tall "$". Authored at 64x64
            with a stem extending below 64 in the source; we crop to the
            64-square arc + $-glyph area and let stroke/fill follow
            currentColor so theming + active-state inheritance work the
            same as before. */}
        <svg className={iconSizeClass} fill="currentColor" viewBox="0 0 64 64" aria-hidden="true">
          {/* Open arc (clockwise from upper-right) — filled when active so
              it reads as a coin; thin outline otherwise. */}
          <path
            d={hasTips
              ? 'M45.733,49.493C42.554,51.731 38.679,53.045 34.5,53.045C23.713,53.045 14.955,44.287 14.955,33.5C14.955,22.713 23.713,13.955 34.5,13.955C45.287,13.955 54.045,22.713 54.045,33.5C54.045,37.679 52.731,41.554 50.493,44.733C49.872,45.615 50.084,46.835 50.966,47.456C51.848,48.077 53.068,47.866 53.689,46.983C56.376,43.168 57.955,38.517 57.955,33.5C57.955,20.555 47.445,10.045 34.5,10.045C21.555,10.045 11.045,20.555 11.045,33.5C11.045,46.445 21.555,56.955 34.5,56.955C39.517,56.955 44.168,55.376 47.983,52.689C48.866,52.068 49.077,50.848 48.456,49.966C47.835,49.084 46.615,48.872 45.733,49.493Z'
              : 'M45.733,49.493C42.554,51.731 38.679,53.045 34.5,53.045C23.713,53.045 14.955,44.287 14.955,33.5C14.955,22.713 23.713,13.955 34.5,13.955C45.287,13.955 54.045,22.713 54.045,33.5C54.045,37.679 52.731,41.554 50.493,44.733C49.872,45.615 50.084,46.835 50.966,47.456C51.848,48.077 53.068,47.866 53.689,46.983C56.376,43.168 57.955,38.517 57.955,33.5C57.955,20.555 47.445,10.045 34.5,10.045C21.555,10.045 11.045,20.555 11.045,33.5C11.045,46.445 21.555,56.955 34.5,56.955C39.517,56.955 44.168,55.376 47.983,52.689C48.866,52.068 49.077,50.848 48.456,49.966C47.835,49.084 46.615,48.872 45.733,49.493Z'}
          />
          {/* "S" curve of the $ */}
          <path
            transform="matrix(33.1188,0,0,33.1188,22.1653,44.1114)"
            d="M0.054,-0.154C0.047,-0.172 0.049,-0.192 0.06,-0.209C0.07,-0.225 0.087,-0.236 0.107,-0.238C0.111,-0.24 0.115,-0.241 0.119,-0.241C0.15,-0.244 0.18,-0.227 0.192,-0.198C0.2,-0.174 0.212,-0.156 0.228,-0.143C0.254,-0.12 0.289,-0.109 0.333,-0.109C0.38,-0.109 0.415,-0.119 0.438,-0.139C0.462,-0.159 0.474,-0.182 0.474,-0.208C0.474,-0.225 0.469,-0.239 0.459,-0.251C0.449,-0.263 0.431,-0.273 0.407,-0.282C0.39,-0.288 0.351,-0.299 0.291,-0.313C0.214,-0.333 0.159,-0.356 0.128,-0.384C0.084,-0.424 0.062,-0.472 0.062,-0.528C0.062,-0.565 0.072,-0.599 0.093,-0.631C0.114,-0.662 0.143,-0.687 0.182,-0.703C0.221,-0.72 0.268,-0.728 0.323,-0.728C0.413,-0.728 0.481,-0.708 0.526,-0.669C0.557,-0.642 0.578,-0.609 0.589,-0.57C0.593,-0.556 0.59,-0.541 0.582,-0.53C0.573,-0.518 0.56,-0.511 0.546,-0.51C0.535,-0.508 0.524,-0.508 0.513,-0.508C0.482,-0.506 0.452,-0.523 0.437,-0.551C0.432,-0.565 0.424,-0.576 0.413,-0.584C0.393,-0.6 0.362,-0.608 0.322,-0.608C0.28,-0.608 0.247,-0.6 0.223,-0.583C0.208,-0.571 0.2,-0.557 0.2,-0.538C0.2,-0.521 0.207,-0.507 0.222,-0.495C0.24,-0.479 0.284,-0.463 0.354,-0.447C0.425,-0.43 0.477,-0.413 0.51,-0.395C0.544,-0.378 0.571,-0.353 0.59,-0.323C0.609,-0.292 0.618,-0.254 0.618,-0.208C0.618,-0.167 0.607,-0.129 0.584,-0.093C0.561,-0.057 0.529,-0.031 0.487,-0.013C0.446,0.004 0.394,0.013 0.332,0.013C0.241,0.013 0.172,-0.008 0.123,-0.05C0.092,-0.077 0.069,-0.111 0.054,-0.154Z"
          />
          {/* Vertical stem through the $ */}
          <path
            transform="matrix(0.875559,0,0,1.16667,-347.241,-5.33333)"
            d="M429.716,20L429.716,44C429.716,44.946 430.739,45.714 432,45.714C433.261,45.714 434.284,44.946 434.284,44L434.284,20C434.284,19.054 433.261,18.286 432,18.286C430.739,18.286 429.716,19.054 429.716,20Z"
          />
        </svg>
        {hasTips && (
