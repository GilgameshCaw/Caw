...
const Staking = () => {
  ...
  //
  // Reality check on wallet behavior: Rabby silently auto-switches the
  // active chain to match domain.chainId before signing, and mobile MM
  // pops its own switch prompt before the sign prompt. We do NOT try to
  // restore the user to L1 after the sign — on mobile that means a third
  // round-trip through the wallet app, which is worse UX than the wallet
  // landing on L2. Acceptable end-state: user finishes on L2; reload or
